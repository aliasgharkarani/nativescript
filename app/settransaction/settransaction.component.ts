...
export class SetTransactionComponent {
    ...
    public constructor(private location: Location, private authService:AuthService, private memberService:MemberService,private router: Router, private activatedRoute: ActivatedRoute, private _page: Page) {
        this.input = {
            "firstname": "",
            "lastname": "",
            "email": "",
