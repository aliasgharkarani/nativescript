...
export class VerifyNumberComponent {
    ...
    public constructor(private location: Location, private memberService:MemberService,private authService:AuthService,private router: Router, private activatedRoute: ActivatedRoute, private _page: Page) {
        this.input = {
            "firstname": "",
            "lastname": "",
            "email": "",
